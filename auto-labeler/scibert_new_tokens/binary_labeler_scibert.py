...
# ------------------------------------------------- #
# Title: binary_labeler_scibert.py
# Description: trains the model for binary (Y/N) classification of biomimicry papers
# Procedure: 
...
def setup_dataset():
    ...
    """
    filename = 'golden.csv' #SINGLELABEL_Colleen_and_Alex_training_data_4.19.csv'
