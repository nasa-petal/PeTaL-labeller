...
def main(results_path, plots_path, verbose):
    ...
    plt.plot(size, p1, linestyle='-', label='P@1')
    plt.plot(size, p3, linestyle='-', label='P@3')
    plt.plot(size, p5, linestyle='-', label='P@5')
    plt.plot(size, n3, linestyle=':', label='nDCG@3')
    plt.plot(size, n5, linestyle=':', label='nDCG@5')
    ...
    plt.plot(aug_factors, p1, linestyle='-', label='P@1')
    plt.plot(aug_factors, p3, linestyle='-', label='P@3')
    plt.plot(aug_factors, p5, linestyle='-', label='P@5')
    plt.plot(aug_factors, n3, linestyle=':', label='nDCG@3')
    plt.plot(aug_factors, n5, linestyle=':', label='nDCG@5')
    ...
    plt.bar(opts, p1, linestyle='-', label='P@1')  
